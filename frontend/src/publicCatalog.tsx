  ...
  return (
    <main className="ds-catalog">
      ...
      >
        ...
        {/*
          Три обещания под заголовком.

          Возврат и замена адреса — раздел 5 оферты («Возврат»).

          Соответствие документов держится на собственнике и проверке
          оператором: документы готовит собственник, сервис их принимает и
          проверяет, но не составляет. Генератор DOCX в app/services/
          document_generation.py к выдаваемому комплекту отношения не имеет —
          не принимать его за основание этого тезиса.
        */}
